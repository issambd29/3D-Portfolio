...
const projects = [
  ...
  {
    name: "Salhi Platform",
    description: "Official educational platform for Professor Salhi (منصة الأستاذة صالحي) specialized in Islamic Education for Algerian Baccalaureate students. Features interactive course modules, comprehensive summaries, exercises, past exams with model answers, and student authentication.",
    tags: [
      { name: "react", color: "blue-text-gradient" },
      { name: "tailwind", color: "blue-text-gradient" },
      { name: "education", color: "green-text-gradient" },
      { name: "baccalaureate", color: "orange-text-gradient" },
      { name: "e-learning", color: "pink-text-gradient" },
    ],
    image: null,
    source_code_link: "https://github.com/issambd29",
    live_demo_link: "https://oustada-salhi.com",
    type: "react",
    badge: "Official Educational Platform",
  },
  {
